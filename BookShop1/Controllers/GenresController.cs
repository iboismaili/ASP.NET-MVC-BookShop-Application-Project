...
namespace BookShop1.Controllers
{
    public class GenresController : Controller
    {
        ...
        public GenresController(BookShop1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Genre != null ? 
                          ...
                          Problem("Entity set 'BookShop1Context.Genre'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BookShop1Context.Genre'  is null.");
            }
            var genre = await _context.Genre.FindAsync(id);
            if (genre != null)
            {
