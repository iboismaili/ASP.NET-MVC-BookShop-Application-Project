...
namespace BookShop1.Controllers
{
    public class UserBooksController : Controller
    {
        ...
        public UserBooksController(BookShop1Context context)
        {
            _context = context;
        }
        ...
        {
            var bookShop1Context = _context.UserBooks.Include(u => u.Book);
            return View(await bookShop1Context.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BookShop1Context.UserBooks'  is null.");
            }
            var userBooks = await _context.UserBooks.FindAsync(id);
            if (userBooks != null)
            {
